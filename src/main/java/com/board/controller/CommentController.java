...
public class CommentController {
    ...
    @GetMapping
    public ResponseEntity<Page<CommentResponse>> findAllComments(@RequestParam Long articleId,
                                                                 @RequestParam(defaultValue = "0") int page,
                                                                 @RequestParam(defaultValue = "10") int size) {
        Pageable pageable = PageRequest.of(page, size);
        Page<CommentResponse> commentResponses = commentService.findAllComments(articleId, pageable)
